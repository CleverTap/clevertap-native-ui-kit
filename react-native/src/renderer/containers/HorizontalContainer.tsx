    ...
    >
      {resolvedStyle.background && (
        <BackgroundRenderer
          ...
          // HorizontalContainer View renders at e.g. 420dp wide, a bg child with
          // `width: '100%'` collapses to the text's ~290dp intrinsic width and the
          // gradient appears truncated while the sibling image overflows past it.
