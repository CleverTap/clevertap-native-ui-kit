...
//
//  UITableViewCell wrapper for SwiftUI NativeDisplayView
//

import UIKit
import SwiftUI

/// UITableViewCell that hosts the SwiftUI NativeDisplayView.
/// Use this to display native display content in UITableView.
///
/// Example usage:
/// ```swift
...
///     let cell = tableView.dequeueReusableCell(withIdentifier: "SDUICell", for: indexPath) as! NativeDisplayTableViewCell
